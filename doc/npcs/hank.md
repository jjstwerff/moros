...
| Offers to find her benefactor for her | Interested — carefully. She will *not* hand over ten years of saved coin on a first conversation with strangers; the bag stays in its drawer. What she gives them instead: a sealed letter for **Ingram** at the Salmonswell orphanage asking *"is he alive, and where?"*, and the description she has carried. *"Go to Ingram first. Come back with what he tells you. If the road keeps its word on that, we'll talk about the bag."* The first trip is reconnaissance *and* trust. |
| Returns from Salmonswell with the name and the location | Goes very still. Sits down. Asks them to repeat the name. Asks them to repeat the description. If Ingram sent a countersigning line with them, she reads it twice. Then she asks a question she has not told them to look for: *"Did he have a scar across his left cheek?"* — the detail only Hanny holds from her own memory of the road. If they confirm it, she is certain. Only then does she open the drawer and lift out the leather purse. *"Take it to him. Whatever he says, bring it back."* She gives them a second letter — a short one, unsealed — for the sergeant himself. She does not write his name on the outside. |
| Returns from Luchebert with Darrel's refusal and asks where the coin should go | Considers. Does not propose a destination unprompted. *"Now it is mine to give. Where does it really help?"* If the party proposes a specific use that benefits **Brumal refugees** concretely — winter food at her farm or Ingram's; medicine for a known household; blankets carried on Nadine's next run — she releases the bag for that use, with the party as the carriers. **Vague charity** (*"for the refugees"*) is refused; she will hold the bag rather than spend it imprecisely. A party that proposes well walks the coin where it is needed; she asks for a return visit afterwards, to be told how it landed. |
...
| **Brother Darrel** | *"I don't know that name. If you mean the Beaver-folk sergeant Ingram described — stocky, heavy shoulder, scarred hands, a scar across his left cheek — that's the man I've been saving the bag back for. Ten years of coin. Ingram would never give the name. I'd go to him myself if the farm would let me."* |
...
- **The Brother Darrel thread is an active quest — Hank's suspicion, not her knowledge — and it is two trips, not one.** Hank does not know the benefactor's name; Ingram has held it for decades at Darrel's request. Hank has a decade-long resolve and the description. She will *not* commit the bag to strangers on a first offer. The arc:
  - **Trip 1 — Elmsfield → Salmonswell, letter only.** Hank gives the party a sealed letter for Ingram asking whether the sergeant is alive and where. *The money stays in the drawer.* This trip is reconnaissance and trust-earning in equal measure.
  - **Between trips — back in Elmsfield.** Party returns with **Darrel's name**, his location (Luchebert), and ideally a countersigning line from Ingram confirming they stood in his office. Hank sits with the name for the first time. *Now* she opens the drawer.
