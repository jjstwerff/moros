...
- **Early-game — return the medallion to Gap city.** Among the wartime items still encoded on the slate is a small engraved medallion left in the Inn's keeping by a family that lived in Elmsfield two generations back. The line did not survive the war on this side; what's left of it migrated south to **Gap city**, across the desert, past **Fata morgana**. Bridget will not go herself — Elmsfield does not run without her — but a party heading south can carry it. *Where this goes:* through the **southern desert** (the **Three Walls** sanded village and the **Half-Tower** ruin sit on plausible routes — see `../places/southern_desert.md`); through **Fata morgana**, where **Nadine** has heard the family name may already be known; to **Gap city** itself, with the family mark and a request for word back. A party that does this earns Bridget's standing for life — and the slate gets a new mark she will explain. The medallion is also the gentlest path into the slate's encoded side: she gives the entry first, before any of the larger ones. **A second encoded entry, less central**, sits two columns to the right — *a press-house family from a vineyard ridge in what is now the broken lands*; the line ended at the rift but the family-name surfaces in pre-rift documents at the **Press-house ridge** (`doc/places/press_house.md`). A party that brings Bridget a Pair-related document or a bottle from the press-house cache opens this conversation; she will pour one of the bottles quietly and add a mark she will explain.
- **Later-game — the long safety of the Inn and the town.** The Inn is inside the great ironwood; Elmsfield is built around it. Brumal's collapse, Hannes's war, the **Leatherman** railroad's pressure on the trade road, **Diederik**'s overseas-pollination plan if it ever fruits her tree shut — every one of these is a path to losing both. She has no strategy yet. *Where this goes:* to **Diederik**, for the conversation about the tree she has not yet had (he can tell her what it is, what fruiting would cost, and what the overseas plan would actually do); to **Corné Dunham** and **Ralph Overhill** for the badger-clan side when the town needs the clan to move; to **Hank** for the farm-side of any refugee influx; to **Felicia** if the spirit-corridor path opens at Brumal's southern border (Elmsfield sits on the line that corridor would have to follow). A party that helps her see how the pieces connect, and steers outcomes toward a town that survives in some recognisable shape, is a party she will back as far as she can.
...
> *"There used to be more floors above this one. The ceiling I've boarded over — that's a floor I can't get to. Not because it's magic. The tree's gripped the planks. It's been gripping them a little tighter every year since they were laid, and now every edge is pinched in bark on all four sides. You'd pull them out with an ordinary crowbar and a lot of sweat — days of it, above your head, and nobody in Elmsfield has a spare week to give me. And I'm not closing the Inn for a week of hammering overhead. Who'd drink under that? Who'd sleep? Who'd I feed? Find me hands, and a way the room keeps running while the hands work, and we've a conversation. I've measured the gap three times. There's room up there. Whoever lived in this tree before us used the height. I want it back — but not at the price of losing a week's custom to get it."*
...
|---|---|
| Offers to pry the planks out for her | Not a refusal — an interview. *"Not through the tree. Never through the tree. You prise the planks, you don't split the bark, and you don't stop halfway. And my Inn stays open. Find me a way to do it without shutting the room for a week, and we're talking."* It is genuinely days of overhead work; she wants to see who's still willing once they've felt the first hour of it — *and* who can solve the closure problem. |
...
| Finds the narrow shaft once inside the upper floor | Bridget does not know it is there. Bring her up to see it and she goes quiet for a long moment, then asks if they'll help her climb. If they climb it first and bring back what's in the compartment, her response depends on what they do with it — returned freely, she is theirs; pocketed quietly, she notices, and the slate gets a new mark. |
