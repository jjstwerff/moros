...
- `doc/npcs/laurent.md` — **rewritten** (demi-lich in the wreck of his own crashed flying city — dangerous undead conversationalist). Six trigger-keyed stories centred on the downfall narration, mannerisms anchored on the fire-in-his-eyes and the alcove puppets twitching with his mood, thirteen reaction triggers covering the necklace path vs. no-necklace, looting vs. listening, and shackle-break news, ten cross-NPC takes. The file flags the *last-flight* conversation as the load-bearing climax option and his passive spirit-shield role as a campaign-scale consideration.
