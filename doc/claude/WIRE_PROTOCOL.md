...
contract the three ids beside it share. **Eleven left** — `36` was written at `S2c` (2026-08-18), for the reason this note gives: its absence is what let the server keep a second body of the gesture with nothing pointing at it. They arrived after the
