...
**Next:** **`D2c`** — the four walls are all stamped — then **`D2b`**, the *is there a building
here* gate the two genuinely ungated verbs need. **`T1`** is independent of both.
