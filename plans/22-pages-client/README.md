...
**Next:** **`T1`** proper — a type declares its defaults and its own verbs, as DATA. Its
premise is paid; what is left is the FORMAT, and ⚠ [EDITING_MODES](../../doc/claude/EDITING_MODES.md)
forbids a fourth way of saying *what this thing is called and what it is made of* — plan 21's
shipped palette and PARTS' tagged sections are the two that exist, and one of them has to be it.
