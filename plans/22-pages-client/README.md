...
**Next:** **`T1`** — a type declares its defaults and its own verbs, as DATA. It is the last
row above the *client is testable here* line that is not blocked on loft#950.
