...
**Next:** **`D2a`** — put the mode's line outside the wall an author stands on — then **`D2b`**,
the *is there a building here* gate the two genuinely ungated verbs need. **`T1`** is independent
of both.
